...
```
  ...
  The number of cluster is selected based on 20 runs of EM algorithm, and it shows that clustering with 3 clusters has the lowest average AIC. With each cell assigned to cluster, PC component plot displays a well separated cluster pattern.
...
```
  ...
  Result from gaussian mixture clustering is used as response variable and conduct classification. For cluster 
