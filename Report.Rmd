...
>>>>>>> c96a4e466e7785a034dbecb2b7742d1ce9bcf63f
...
VlnPlot(sngcll_seurat, features = c("cpxm1", "ccnb2"))
```
...
” by Koki Tsuyuzaki1etc.  
[3] "ZIFA: Dimensionality reduction for zero-inflated single-cell gene expression analysis" by Emma Pierson and Christopher Yau  
[4] "Integrated analysis of multimodal single-cell data" by Hao and Hao et al
